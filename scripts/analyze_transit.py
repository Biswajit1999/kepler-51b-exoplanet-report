"""Transit-window analysis of a real TESS SPOC light curve for Kepler-51 b.
...
DATA_FILE = DATA_DIR / "tess2019198215352-s0014-0000000027846348-0150-s_lc.fits"
PLANET = "Kepler-51 b"
PERIOD_DAYS = 45.154
EPOCH_BJD = 2455714.5977
DURATION_HOURS = 5.797
SECTOR = 14
FIGURE_FILE = FIG_DIR / "kepler51b_tess_transit.png"
...
def main() -> dict[str, float]:
    ...
    ax.scatter(hours, (result["flux"] - 1) * 1e6, s=5, alpha=0.12, color="#862e9c", label="quality-filtered cadences")
    ...
    ax.plot(hours[order], (result["model"][order] - 1) * 1e6,
            color="#862e9c", linewidth=2.2, label="fitted box model")
    ax.axvspan(-DURATION_HOURS / 2.0, DURATION_HOURS / 2.0, color="#862e9c", alpha=0.08)
